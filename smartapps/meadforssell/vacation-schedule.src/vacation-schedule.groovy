 ...
 *
 *  Vacation Schedule for lighting
 *
 *  Author: Phil Mead
 *
 *  Turn on some lights at a specified time and turn them off later time. Template for a vacation schedule.
 */
...
definition(
    ...
    author: "Phil Mead",
    description: "Turn on some lights at a specified time and turn them off later time",
