 ...
 *
 *  Scheduled Lights Off
 *
 *  Author: Phil Mead
 *
 *  Turn off lights at a specified time. Mostly incase we or a service person forgets to turn off lights
 */

definition(
    name: "Scheduled Lights Off",
    namespace: "meadforssell",
    author: "Phil Mead",
    description: "Turn off lights at a specified time.",
